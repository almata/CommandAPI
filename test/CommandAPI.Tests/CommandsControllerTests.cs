...
namespace CommandAPI.Tests
{
    public class CommandsControllerTests : IDisposable
    {
        ...
        {
            // Arrange
            mockRepo.Setup(repo => repo.GetCommandById(1)).Returns(GetCommands(1).Single());
            var controller = new CommandsController(mockRepo.Object, mapper);
        ...
        public void PartialUpdateCommand_Returns404NotFound_WhenNonExistentResourceIDSubmitted()
        {
            ...
            // Act
            var result = controller.PartialUpdateCommand(1, new Microsoft.AspNetCore.JsonPatch.JsonPatchDocument<CommandUpdateDto> {});
